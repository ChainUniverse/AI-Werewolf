...
function formatHistoryEvents(events: string[]): string {
...
export function getRoleNightAction(playerServer: PlayerServer, context: PlayerContext | SeerContext | WitchContext): string {
